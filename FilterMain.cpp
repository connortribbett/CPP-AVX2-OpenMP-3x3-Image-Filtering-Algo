    ...
    for(int plane = 0; plane < 3; plane++){
        for(int row = 1; row < h; row++) {
            ...
            for(; col < w - 5; col = col + 6) { //Calculate 6 pixels at once for 1 plane
				...
				//upper1 = _mm256_add_ps(upper1, _mm256_add_ps(lower1, middle1));
                //upper2 = _mm256_add_ps(upper2, _mm256_add_ps(lower2, middle2));
                //upper3 = _mm256_add_ps(upper3, _mm256_add_ps(lower3, middle3));
